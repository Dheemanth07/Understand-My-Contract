...
describe('useIsMobile hook', () => {
  ...
  it('updates state when resizing from mobile to desktop', () => {
    ...
    act(() => {
      ...
      const listeners = (matchMediaMock.mock.results[matchMediaMock.mock.results.length - 1].value.addEventListener as jest.Mock).mock.calls;
  ...
  it('removes event listener on unmount', () => {
    ...
    const matchMediaMock = window.matchMedia as jest.Mock;
    const mockMediaQueryList = matchMediaMock.mock.results[matchMediaMock.mock.results.length - 1]?.value;
